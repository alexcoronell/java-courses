...
public class JobSearch {
    public static void main(String[] args) {
        ...
        Stream<CLIArguments> streamOgCLI = parseArguments(jCommander, args, JCommander::usage)
                .orElse(Collections.emptyList())
                .stream()
                .map(obj -> (CLIArguments) obj);

        Optional<CLIArguments> cliArgumentsOptional = streamOgCLI.filter(cli -> !cli.isHelp())
